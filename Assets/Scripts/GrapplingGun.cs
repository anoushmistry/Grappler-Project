...
public class GrapplingGun : MonoBehaviour
{
    ...
    [SerializeField] public LaunchType launchType;
    ...
    [Header("Sounds")]
    [SerializeField] private AudioSource grappleShoot;
    ...
    private void Update()
    {
        if (Input.GetKeyDown(KeyCode.Mouse1) && grappleRope.isGrappling == false )
        {
    ...
    void SetGrapplePoint()
    {
        ...
        if (Physics2D.Raycast(firePoint.position, distanceVector.normalized))
        {
            ...
            if (_hit.transform.gameObject.layer == grappableLayerNumber || grappleToAll)
            {
                ...
                /* else if(Vector2.Distance(_hit.point, firePoint.position) > maxDistnace || !hasMaxDistance)
                 {
                     grappleLengthExceeded.Play();
                 }*/
            }
        }
    }
